...
namespace im_param {
    ...
    struct UserLand
    {
        ...
        {
            std::cout << "UserLand<BE,UT,TH>::specialization(BE& be, UT& ut, const TH& th) " << "\n";
    ...
    template<class BE, class UT, std::enable_if_t<is_fundamental_type<UT>::value, bool> = true>
...
int im_param_foundations_level_06(int argc, char* argv[]) {
